                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome to the Update Categories Page</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach($categories as $category){
                                                                echo "
                                                                   ...
                                                                   <td><a href='../admin/updatecategory.php?cat_id={$category['cat_id']}'><i class='fa fa-pencil' aria-hidden='true'></i></a></td>
                                                                   <td><a href='../actions/delete_category.php?cat_id={$category['cat_id']}'><i class='fa fa-trash' aria-hidden='true'></i></a></td>
                                                                   </tr>
                                                                   ";
                                                                   }
                                                            ?>
