                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        <div class="section-title">
                            <span>About Healthy Oven Bakery</span>
                            <h2>Cakes and bakes from the house of Queens!</h2>
                        </div>
                        <p>The "Healthy Oven Bakery" is a Ghanian Brand that started as a small family business. The
                            owner is
                            Mrs Ophelia Ampomah-Benefo, supported by a staff of 10 employees.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7">
                    <!-- <div class="map__inner">
                        <h6>Healthy Oven Bakery</h6>
                        <ul>
                            <li>JWJJ+PVR, Sakumono, Greater Accra, Ghana</li>
                            <li>+233 020 264 2538</li>
                        </ul>
                    </div> -->
                </div>
            </div>
