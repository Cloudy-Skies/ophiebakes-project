    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__option">
            <ul>
                ...
                <li><a href='../actions/logout.php'>Log out</a> <span class="arrow_carrot-down"></span></li>
            </ul>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product__details__img">
                        <div class="product__details__big__img">
                            <img class="big_img" src='../images/products/{$product["product_image"]}' alt="">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <div class="product__label"><?php echo "{$product['product_cat']}"; ?></div>
                        <h4><?php echo "{$product['product_price']}"; ?></h4>
                        <h5>$26.41</h5>
                        <p><?php echo "{$product['product_desc']}"; ?></p>
                        <ul>

                            <li>Category: <span><?php echo "{$product['product_cat']}"; ?></span></li>
                            <li>Keywords: <span><?php echo "{$product['product_keywords']}"; ?></span></li>
                        </ul>
